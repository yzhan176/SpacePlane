...
def run():
    ...
    temp = -936
    print("The initial lives of the plane are ", myPlane.lives)
    while True:
        ...
        for hit in hits:
            ...
            if myPlane.shield <= 0:
                ...
                myPlane.hide()
                myPlane.lives -= 1
                print("The plane is destroyed, the remaining lives are ", myPlane.lives)
                myPlane.shield = 100

        # if the plane died and its live is 0, we will end the game
        if myPlane.lives == 0:
            print("The live of plane is 0, so game over")
            game_over(score)
...
# test code
# when the plane is destroyed, we will print the remaining lives of the plane
